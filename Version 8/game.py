...
#create_tilemap
#draw_level_up
#sieht jetzt auch benötigte xp gedrawed
import pygame
...
class Game:
    ...
    def update(self):
        self.player.update(self.enemies, self.blocks) #Aktualisiert die Position des Spielers mit Kollisionserkennung
    ...
    def draw_xp(self):
        font = pygame.font.Font(None, 50)
        xp_text = font.render("XP: " + str(self.player.xp) + "/" + str(self.player.xp_for_next_level), True, (0, 255, 0)) #oder als f-string
