...
#printen wenn gestorben
#enemy.draw_aggro also Ausrufezeichen sobald enemy den player verfolgt in Abhängigkeit vom chasen also in range drawen
#draw_attack_range für player extra für Übersichtlichkeit
#sieht jetzt auch attack range wenn attacked
#draw_game_level
#spawn_enemies() jetzt auch in run
#spawn_enemies jetzt auch angepasst dass die nicht mehr in oder in Nähe vom Spieler und nicht mehr in Wänden spawnen können
#neues Hintergrund und Portal Bild
#.set_colorkey damit weißer Hintergrund von Portal Bild weg
#Portal vergrößert
#draw_attack dass jetzt wenn man 1 drückt also angreift angreifs bild kommt und wenn man tab drückt man immer noch die range normal wie vorher sieht
#Game level auch auf das Banner Bild geschrieben
#pygame.FULLSCREEN für Vollbild
#in handle_events dass wenn esc drückt pause_menu aufgerufen wird
#self.player.health = 0 damit da keine negative Zahl steht
#xp runden unten jetzt damit keine krummen Zahlen da stehen
#random map auswahl jetzt
#self.blocks.empty() damit sich maps nicht "adden" und ab ca. 3.Level nur noch eine kommt immer
#self.all_sprites.empty()
#draw_traenke
#pygame.quit() auskommentiert weil sonst mit gameover nicht mehr klappt
import pygame
