...
#Methode self.draw_attack_ranges damit man Tab drücken kann für attack ranges sehen - man sieht wird nur in Mitte gehittet
#Verschiedene Gegner Bilder(müssen noch nach welchen suchen), Größen, stats
#################
#stats scalen jetzt mit level
import pygame
import random
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self, game_level):
        ...
        self.health = random.randint(20, 50) + game_level * 5 #Gibt Lebenspunkte der Gegner an (skaliert mit Level)
