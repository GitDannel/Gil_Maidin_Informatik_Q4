...
#import math für move also Distanz player enemy
#move und speed
#draw_aggro damit sieht wenn player von enemies verfolgt wird
#neues enemy Bild
#.convert und .set_colorkey damit weißer Hintergrund von Bild weg
#Auswahl aus mehreren Gegner Images
import pygame
import random
import math
